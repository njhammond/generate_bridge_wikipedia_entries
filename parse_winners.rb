...
#      puts "ph=#{ph} country=#{country}"
    ...
    wiki_category = "[[Category:American contract bridge players]]"
    if (has_country == 1) then
      ...
      when "FRA"
        ...
        wiki_category = "[[Category:French contract bridge players]]"
      when "ITA"
        country_ref = "is an [[Italy|Italian]]"
        short_description = "Italian contract bridge player"
        wiki_category = "[[Category:Italian contract bridge players]]"
      when "ISR"
        country_ref = "is an [[Israel|Israeli]]"
        short_description = "Italian contract bridge player"
        wiki_category = "[[Category:Israeli contract bridge players]]"
      when "MCO"
        country_ref = "is a [[Monaco|Monagesque]]"
        short_description = "Monagesque contract bridge player"
        wiki_category = "[[Category:Monagesque contract bridge players]]"
      when "POL"
        country_ref = "is a [[Poland|Polish]]"
        short_description = "Polish contract bridge player"
        wiki_category = "[[Category:Polish contract bridge players]]"
      end
    end
